...
And when a strategy asks before it acts, the page tells you the command that
decides it — the dashboard still cannot write anything itself:

<p align="center">
  <img src="docs/screenshots/approval.png" alt="A remediation awaiting approval: the commands that approve or deny it, and when silence becomes an escalation" width="820">
</p>

The [remediations list](docs/screenshots/remediations.png) and
[strategies](docs/screenshots/strategies.png) pages are in
