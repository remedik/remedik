...
remedik takes actions in other people's clusters. That makes a particular
kind of contribution unwelcome regardless of how it is worded: changes that
weaken a safety property without saying so, benchmarks or test results
reported selectively, or a claim that something is proven when it has not
been run.

This is not a matter of tone. Somebody will read this repository and decide
to give an operator write access to production on the strength of what it
says about itself.
...
reported to the maintainers through a [private security
advisory](https://github.com/remedik/remedik/security/advisories/new), which
is the one reporting channel in this repository that is not public.
